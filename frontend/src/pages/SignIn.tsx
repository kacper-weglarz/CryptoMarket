...
export function SignIn() {
    ...
    return (
        <div className="flex min-h-screen w-full items-center justify-center p-4">
            ...
            <Link to="/" className="absolute left-4 top-4 flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium
                            text-[var(--text-muted)] transition-colors hover:bg-[var(--nav-bg)] hover:text-[var(--text-app)] sm:left-8 sm:top-8">
            ...
            <div className="w-full max-w-md rounded-3xl border border-[var(--nav-border)] bg-[var(--nav-bg)]/80 p-8
                ...
                <div className="mb-8 text-center">
                    ...
                    <h1 className="text-2xl font-bold tracking-tight text-[var(--text-app)]">Dołącz do nas!</h1>
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                    ...
                    <div className="space-y-1.5">
                        <label className="text-xs font-medium text-[var(--text-muted)] ml-1">Nazwisko</label>
                        <div className="relative group">
                            <div className="absolute left-3 top-1/2 -translate-y-1/2 text-[var(--text-muted)] transition-colors
                                                group-focus-within:text-emerald-500">
                                <User className="h-5 w-5" />
                    ...
                    <div className="space-y-1.5">
                        <label className="text-xs font-medium text-[var(--text-muted)] ml-1">Alias</label>
                        <div className="relative group">
                            <div className="absolute left-3 top-1/2 -translate-y-1/2 text-[var(--text-muted)] transition-colors
                                                group-focus-within:text-emerald-500">
                                <User className="h-5 w-5" />
                ...
                <div className="grid grid-cols-1 gap-3">
                    <button className="flex items-center justify-center gap-2 rounded-xl border border-[var(--nav-border)]
                                            ...
                                            hover:bg-[var(--nav-bg)] hover:border-zinc-500 w-full">
                        <svg className="h-4 w-4" viewBox="0 0 24 24"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26
                                        1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"/><path
                                        d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71
                                         1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/><path
                                        d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43
                                        3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05"/><path d="M12 5.38c1.62 0 3.06.56 4.21
                                        1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"
                                                                                                fill="#EA4335"/></svg>
                        Google
                    </button>
                </div>
