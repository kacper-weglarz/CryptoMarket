                        ...
                        <tr key={item.symbol} className="group hover:bg-zinc-500/5 transition-colors">
                            <td className="px-8 py-4">
                                <div className="flex items-center gap-4">
                                    <div className="w-9 h-9 rounded-full bg-nav-bg flex items-center justify-center font-bold text-emerald-500
                                            border border-nav-border shadow-sm group-hover:border-emerald-500/50 transition-colors overflow-hidden">
                                        <img
                            ...
                            <td className="px-8 py-4 text-right">
                                <div className="flex flex-col items-end">
                                    <span className="font-bold font-mono text-emerald-500">
                                        ${item.valueInUsd.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                    </span>
                                </div>
                            </td>
                            <td className="px-8 py-4 text-right">
